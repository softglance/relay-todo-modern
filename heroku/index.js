...
var _subscriptionHandler = require('./subscriptionHandler');
...
var httpServer = app.listen(GRAPHQL_PORT, function () {
...
io.on('connection', function (socket) {
  socket.on('graphql:subscription', function () {
    var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/regeneratorRuntime.mark(function _callee(request) {
      var initialPayload;
